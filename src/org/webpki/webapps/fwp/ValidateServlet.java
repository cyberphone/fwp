    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONObjectReader parsedObject = JSONParser.parse(
                    EnrollServlet.getParameter(request, JWS_OBJECT));
            String validationKey = EnrollServlet.getParameter(request, JWS_VALIDATION_KEY);
            String signatureLabel = EnrollServlet.getParameter(request, JWS_SIGN_LABL);
            ...
            if (JWSDecoder.getSignatureAlgorithm().isSymmetric()) {
                JWSValidator = new JWSHmacValidator(EnrollServlet.decodeSymmetricKey(validationKey));
            } else {
