 ...
 *
 */
public class X_BuyServlet extends HttpServlet {
    
    static Logger logger = Logger.getLogger(X_BuyServlet.class.getName());
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        FWPPaymentRequest samplePaymentRequest = 
                new FWPPaymentRequest("Space Shop", BuyServlet.getRequestId(), "435.00", "EUR");
        StringBuilder html = new StringBuilder(
            "<form name='shoot' method='POST' action='x-buy'>" +
        ...
        try {
            ...
            StringBuilder html = new StringBuilder(
                ...
                .append(
                    ...
                    "    const options = {\n" +
                    // Any 32 bytes will do since we (using x-buy) don't run the whole thing...
